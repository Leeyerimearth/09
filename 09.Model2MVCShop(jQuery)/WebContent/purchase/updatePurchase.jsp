...
<table width="600" border="0" cellspacing="0" cellpadding="0"	align="center" style="margin-top: 13px;">
	...
	<tr>
		...
		<input type="hidden" name="buyerId" value="user17">
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	</tr>
	<tr>
		...
		<td class="ct_write01">
			<select 	name="paymentOption" 	class="ct_input_g" style="width: 100px; height: 19px" 
							maxLength="20">
				<option value="1" selected= ${!empty purchase.paymentOption && purchase.paymentOption=='ca ' ? "selected" : ""}>현금구매</option>
				<option value="2" selected= ${!empty purchase.paymentOption && purchase.paymentOption=='cd ' ? "selected" : ""}>신용구매</option>
			</select>
		</td>
	</tr>
	<tr>
